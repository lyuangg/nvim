...
set grepprg=grep\ -rn\ $*\ /dev/null\ ./\ --exclude-dir=.git " grep 设置
set path+=**
...
set wildmode=longest:list,full "命令模式tab补全，第一次显示所有命令，第二次依次选择
set browsedir=buffer " 文件浏览器使用的目录: last, buffer, current
...
noremap <S-Tab> :bprev<Return>
noremap <Tab> :bnext<Return>
